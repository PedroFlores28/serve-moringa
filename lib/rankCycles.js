 ...
 * Configurable por rango objetivo; por defecto 4 ciclos × 350 productos.
 */

const DEFAULT_CYCLE_CONFIG = { totalCycles: 4, productsPerCycle: 350 };

/** Rango que el socio está por alcanzar (nextRankName del dashboard) */
const RANK_CYCLES_BY_TARGET = {
  active: { totalCycles: 4, productsPerCycle: 350 },
  silver: { totalCycles: 4, productsPerCycle: 350 },
  star: { totalCycles: 4, productsPerCycle: 350 },
  master: { totalCycles: 4, productsPerCycle: 350 },
