...
async function loadInputs(referenceDate = new Date()) {
  ...
  return { users, treeNodes, products, activations, virtualTxs, affiliations, residualTxs }
}
...
async function runCierre(opts = {}) {
  ...
  const { users, treeNodes, products, activations, virtualTxs, affiliations, residualTxs } = await loadInputs(referenceDate)
